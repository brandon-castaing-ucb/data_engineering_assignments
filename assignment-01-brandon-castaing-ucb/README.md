...
- What are companies looking for in skills, experience, competencies?
  * Answer:
   1. SQL and familiarity with many RDBMS systems
   1. 2+ years experience with Python and Linux
   1. BS/MS in Computer Science or related technical discipline
   1. Processing frameworks (e.g. Hadoop, Spark)
   1. 2+ years experience working in multitenant cloud environments
